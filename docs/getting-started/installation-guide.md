...
Follow the official [`verl` installation guide](https://verl.readthedocs.io/en/latest/start/install.html), but make sure the environment ends up with `verl==0.8.0`.
...
- prepare a Python environment with `verl==0.8.0`
