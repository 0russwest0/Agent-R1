...
| --- | --- | --- |
| `gsm8k` | Grade-school math reasoning. It includes both a plain data path and an agent path where the environment can build prompts dynamically and expose `calc_gsm8k_reward`. | `data_preprocess/process_gsm8k.py`, `data_preprocess/process_gsm8k_agent.py`, `gsm8k_agent_flow.py`, `env/gsm8k_tool_env.py` |
