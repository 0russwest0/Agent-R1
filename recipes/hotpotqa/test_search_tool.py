...
Run from repo root (same Python env as training):
  ...
  python recipes/hotpotqa/test_search_tool.py
  python recipes/hotpotqa/test_search_tool.py "Who founded Apple?"

Optional env vars (same as recipes/hotpotqa/utils.py):
...
from recipes.hotpotqa.utils import (  # noqa: E402
